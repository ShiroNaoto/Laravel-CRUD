                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          <div class="dropdown-menu" role="menu">
                            <a class="dropdown-item" data-toggle="modal" data-target="#updateTicket{{ $ticket->id }}" >Edit</a>
    ...
    <div class="modal fade" id="updateTicket{{ $ticket->id }}">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="post" action="{{ route('updateComp') }}">
                    @csrf
...
<div class="modal fade" id="destroyTicket{{$ticket->id}}">
    <div class="modal-dialog">
    <form method="POST" action="{{ route('destroycompAdminTicket')}}">
               @csrf
               @method('DELETE')
               <input type="hidden" name="id" value="{{ $ticket->id }}">
        <div class="modal-content bg-danger">
            ...
            <div class="modal-body">
                <p>Are you sure you want to delete {{ $ticket->staffname}}'s request?</p>
            </div>
            <div class="modal-footer justify-content-between">
